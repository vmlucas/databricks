...
pacientes_df.write.mode("overwrite").saveAsTable("hupe.pacientes_hupe")
...
atends_df.write.mode("overwrite").saveAsTable("hupe.atendimentos_hupe")
...
aplics_df.write.mode("overwrite").saveAsTable("hupe.aplicacoes_hupe")
